...
public:
    ...
    __device__ __forceinline__ void launch(bool active)
    {
        ...
        if (active)
        {
            ...
            query = make_float3(batch.points.ptr(0)[query_index], batch.points.ptr(1)[query_index], batch.points.ptr(2)[query_index]);
        ...
        if (query_index != -1&& found_count>=3) {
            ...
            batch.queries[query_index] = make_float4(query.x, query.y, query.z, 0);//TODU:可
        }
        else
